...
**pyelftools** is using and providing Type Hints, following `PEP 484 <https://peps.python.org/pep-0484/>`_.
...
pyelftools aims to use [ty](https://docs.astral.sh/ty/) as its type checker.
