...
class ELFFile:
    ...
    """
    def __init__(self, stream: IO[bytes], stream_loader: Callable[[str], IO[bytes]] | None = None) -> None:
        self.stream = stream
        ...
        self._section_header_stringtable: StringTableSection | None = None # Lazy load
        self._section_name_map: dict[str, int] | None = None
        self.stream_loader = stream_loader

    @classmethod
    def load_from_path(cls, path: str) -> ELFFile:
