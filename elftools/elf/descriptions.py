...
_DESCR_E_MACHINE = dict(
    ...
    EM_S390='IBM S/390',
    EM_MIPS_RS3_BE='MIPS RS3000 little-endian',
    ...
    EM_PPC64='PowerPC64',
    EM_RISCV='RISC-V',
    EM_MSP430='TI MSP430 Embedded Microcontroller',
    EM_TI_C6000='TI TMS320C6x Real-Time Microcontroller',
    EM_TI_C2000='TI TMS320C2x Real-Time Microcontroller',
    EM_TI_C5500='TI TMS320C55x Real-Time Microcontroller',
