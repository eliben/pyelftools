...
#12
ENUM_TAG_ADVANCED_SIMD_ARCH_ARM = dict(
    NOT_PERMITTED=0,
    NEON_PERMITTED=1,
    NEON2_PERMITTED=2,
...
#14
ENUM_TAG_ABI_PCS_R9_USE_ARM = dict(
    R9_V6=0,
    R9_SB=1,
    R9_TLS_POINTER=2,
    R9_RESERVED=3,
...
#15
ENUM_TAG_ABI_PCS_RW_DATA_ARM = dict(
    RW_ABS=0,
    RW_PC_REL=1,
    RW_SB_REL=2,
    RW_NOT_PERMITTED=2,
...
#16
ENUM_TAG_ABI_PCS_RO_DATA_ARM = dict(
    RO_ABS=0,
    RO_PC_REL=1,
    RO_NOT_PERMITTED=2,
)
...
#17
ENUM_TAG_ABI_PCS_GOT_USE_ARM = dict(
    NOT_PERMITTED=0,
    ADDR_DIRECT=1,
    ADDR_GOT=2,
)
...
#18
ENUM_TAG_ABI_PCS_WCHAR_T_ARM = dict(
    NOT_PERMITTED=0,
    WCHAR_2BYTES=2,
    WCHAR_4BYTES=4,
)
...
#19
ENUM_TAG_ABI_FP_ROUNDING_ARM = dict(
    NEAREST_ROUNDING=0,
    CUSTOM_ROUNDING=1,
)
...
#20
ENUM_TAG_ABI_FP_DENORMAL_ARM = dict(
    POSITIVE_ZERO=0,
    IEEE_DENORMALS=1,
    PRESERVE_FP_SIGN=2,
)
...
#21
ENUM_TAG_ABI_FP_EXCEPTIONS_ARM = dict(
    NOT_PERMITTED=0,
    PERMITTED=1,
)
...
#22
ENUM_TAG_ABI_FP_USER_EXCEPTIONS_ARM = dict(
    NOT_PERMITTED=0,
    PERMITTED=1,
)
...
#23
ENUM_TAG_ABI_FP_NUMBER_MODEL_ARM = dict(
    NOT_PERMITTED=0,
    IEEE_NORMAL=1,
    RTABI=2,
    IEEE_754=3,
...
#24
ENUM_TAG_ABI_ALIGN_NEEDED_ARM = dict(
    NOT_PERMITTED=0,
    ALIGN_8BYTES=1,
    ALIGN_4BYTES=2,
    ALIGN_RESERVED=3,
...
#25
ENUM_TAG_ABI_ALIGN_PRESERVED_ARM = dict(
    NOT_PERMITTED=0,
    PRESERVE_8BYTES=1,
    PRESERVE_ALL=2,
    PRESERVE_RESERVED=3,
...
#26
ENUM_TAG_ABI_ENUM_SIZE_ARM = dict(
    SMALLEST_CONTAINER=1,
    CONTAINER_32BIT=2,
    CONTAINER_VIS_32BIT=3,
)


#27
ENUM_TAG_ABI_HARDFP_USE_ARM = dict(
    HARDFP_IMPLIED=0,
...
#28
ENUM_TAG_ABI_VFP_ARGS_ARM = dict(
    BASE_AAPCS=0,
    VFP_AAPCS=1,
    SPECIFIC=2,
    BASE_AND_VFP=3,
...
#29
ENUM_TAG_ABI_WMMX_ARGS_ARM = dict(
    BASE_AAPCS=0,
    INTEL_WMMX=1,
    SPECIFIC=2,
)
...
#30
ENUM_TAG_ABI_OPTIMIZATION_GOALS_ARM = dict(
    NONE=0,
    SPEED=1,
...
#31
ENUM_TAG_ABI_FP_OPTIMIZATION_GOALS_ARM = dict(
    NONE=0,
    SPEED=1,
    AGGRESSIVELY_SPEED=2,
    SMALL_SIZE=3,
...
#32
ENUM_TAG_COMPATIBILITY_ARM = dict(
    NOT_REQUIRED=0,
    REQUIRED=1,
)
...
#34
ENUM_TAG_CPU_UNALIGNED_ACCESS_ARM = dict(
    NOT_PERMITTED=0,
    PERMITTED=1,
)
...
#36
ENUM_TAG_FP_HP_EXTENSION_ARM = dict(
    USED_IF_AVAILABLE=0,
    PERMITTED=1,
)
...
#38
ENUM_TAG_ABI_FP_16BIT_FORMAT_ARM = dict(
    NOT_PERMITTED=0,
    IEEE_16BIT=1,
    VFPV3_16BIT=2,
)
...
#42
ENUM_TAG_MPEXTENSION_USE_ARM = dict(
    NOT_PERMITTED=0,
    PERMITTED=1,
)
...
#68
ENUM_TAG_VIRTUALIZATION_USE_ARM = dict(
    NOT_PERMITTED=0,
    TZ_PERMITTED=1,
