...
from elftools.construct.macros import Enum

from elftools.dwarf.enums import ENUM_DW_LLE
...
class LocationLists(object):
    ...
    def get_location_list_at_offset(self, offset):
        ...
        return self._parse_location_list_from_stream_v5() if self.version >= 5 else self._parse_location_list_from_stream()
    ...
    def iter_location_lists(self):
        ...
        location list view pairs, which a referenced by the nonstandard DW_AT_GNU_locviews
        ...
        The number of view pairs is determined by the difference between the locviews
        and the location list.
